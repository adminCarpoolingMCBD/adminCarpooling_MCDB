...
public class DriverResourceIntTest {
    ...
    public void initTest() {
        ...
        driver.setAddress(DEFAULT_ADDRESS);
        driver.setMail(DEFAULT_MAIL);
        driver.setAge(DEFAULT_AGE);
        driver.setExperience(DEFAULT_EXPERIENCE);
        driver.setExp(DEFAULT_EXP);
    }
    ...
    public void createDriver() throws Exception {
        ...
        assertThat(testDriver.getExp()).isEqualTo(DEFAULT_EXP);
    }
    ...
    public void updateDriver() throws Exception {
        ...
        updatedDriver.setAddress(UPDATED_ADDRESS);
        updatedDriver.setMail(UPDATED_MAIL);
        updatedDriver.setAge(UPDATED_AGE);
        updatedDriver.setExperience(UPDATED_EXPERIENCE);
        updatedDriver.setExp(UPDATED_EXP);
        ...
        assertThat(testDriver.getExp()).isEqualTo(UPDATED_EXP);
    }
